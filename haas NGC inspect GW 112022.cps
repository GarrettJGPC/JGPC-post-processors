...
properties = {
  ...
  gotChipConveyor: {
    ...
    description: "Enable to turn on and use chip conveyor for this toolpath. Will turn off at start of next path if next does not have it also enabled",
    group      : "configuration",
    type       : "boolean",
    value      : false,
    scope      : "operation",
  ...
  useSmoothing: {
    title      : "Use G187 smoothing",
    description: "G187 smoothing mode. Automatic is based on stock to leave. More accurate modes run slower around corners and slower accel.",
    group      : "preferences",
    type       : "enum",
    values     : [
      {title:"Off", id:"-1"},
...
function onSection() {
  ...
  // GW added logic to turn on and off chipconveyor in onSection
